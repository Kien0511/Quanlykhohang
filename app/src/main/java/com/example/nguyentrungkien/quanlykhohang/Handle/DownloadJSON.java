package com.example.nguyentrungkien.quanlykhohang.Handle;
...
public class DownloadJSON extends AsyncTask<String,Void,String> {
    ...
    public DownloadJSON(String strURL, List<HashMap<String, String>> attrs) {
        this.strURL = strURL;
        this.attrs = attrs;
        isPost = true;
    }

    public DownloadJSON(String strURL) {
        this.strURL = strURL;
        isPost = false;
    }
